    ...
    <div className="text-light-text flex flex-row items-center relative px-14 py-3">
      <div className="flex gap-4 items-center font-medium">
        <a target="_blank" rel="noopener noreferrer" href="https://www.x.com">
          <img className="size-8" src="/icons/twitter.png" alt="Twitter" />
        </a>
        <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com">
          <img className="size-8" src="/icons/facebook.png" alt="Facebook" />
        </a>
        <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com">
          <img className="size-8" src="/icons/instagram.png" alt="Instagram" />
        </a>
